...
$segmen1    = $url[2];
    if ($segmen1 == 'group?input=berhasil' || $segmen1 == 'group?edit=berhasil' ) {?>
...
<div class="card" style="margin: 15px">
    ...
    <div class="card-body">
        <table id="bootstrap-data-table-group" class="table table-striped table-bordered table-hover table-responsive{-sm|-md|-lg|-xl}" style="width:100%">
            <thead>
                <tr>
                    <th>Code</th>
                    <th>Group Name</th>
