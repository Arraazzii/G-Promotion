...
$segmen1    = $url[2];
    if ($segmen1 == 'role?input=berhasil' || $segmen1 == 'role?edit=berhasil' ) {?>
...
<div class="card" style="margin: 15px">
    <div class="card-header bg-flat-color-5">
        <h3 class="text-white"><strong>DATA ROLE</strong></h3>
        <a href="add_role">
    ...
    <div class="card-body">
        <table id="bootstrap-data-table-role" class="table table-striped table-bordered table-hover table-responsive{-sm|-md|-lg|-xl}" style="width:100%">
            <thead>
                <tr>
                    <th>Role</th>
                    <th>Total Master Form</th>
                    <th>#</th>
                </tr>
            </thead>
        </table>
