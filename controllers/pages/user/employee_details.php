...
if (isset($_SESSION['kode_user'])) {
    $kode1 = $_SESSION['kode_user'];
    $edit = mysql_query("SELECT * FROM user JOIN m_role ON user.kode_role = m_role.kode_role WHERE m_role.master = 'employee' AND m_role.edit = 1 AND user.kode_user = '$kode1'") or die(mysql_error());
