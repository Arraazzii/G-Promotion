            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php 
                        ...
                        $q0 = mysql_query("SELECT * FROM m_navigasi JOIN m_role ON m_role.master = m_navigasi.master JOIN user_role ON user_role.akses_role = m_role.kode_role WHERE user_role.kode_user = '$kode_user' AND m_navigasi.id_parent = 1 ") or die(mysql_error());
                        while ($d = mysql_fetch_array($q0)) {?>
                        ...
                        <li class="menu-item-has-children dropdown open show" >
                            ...
                            if ($q['status'] == 0) {?>
                                <ul class="sub-menu children dropdown-menu" id="menu-atas" style="margin-top: 15px">
                            <?php }else{?>
                                <ul class="sub-menu children dropdown-menu show" id="menu-atas" style="margin-top: 15px">
                            <?php }?>
                    ...
                    <?php                
                        $q = mysql_query("SELECT * FROM m_navigasi JOIN m_role ON m_role.master = m_navigasi.master JOIN user_role ON user_role.akses_role = m_role.kode_role WHERE user_role.kode_user = '$kode_user' AND m_navigasi.id_parent = 2 ") or die(mysql_error());
                    ...
                    <?php                
                        $q = mysql_query("SELECT * FROM m_navigasi JOIN m_role ON m_role.master = m_navigasi.master JOIN user_role ON user_role.akses_role = m_role.kode_role WHERE user_role.kode_user = '$kode_user' AND m_navigasi.id_parent = 3 ") or die(mysql_error());
                        while ($d = mysql_fetch_array($q)) { ?>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <p class="float-left" style="margin: 8px;">Hello, <?php echo $_SESSION['nama'] ?>!</p>
                             ...
                             while ($p  = mysql_fetch_array($query1)) {
                                ?>
                                   <li class="active">
                                       ...
                                       <?= $p['nama_navigasi'] ?>
                                       <a href="../admin/controllers/config/p_status_navigasi.php">123123</a>
                                   </li>
                                   <?php 
                                }
                            }
