...
<form action="../admin/controllers/config/p_edit_perusahaan.php" method="post">
    <div class="col-sm-12">
        <label>Company Code <a class="required">*</a></label>
        <div class="input-group">
            <input type="text" name="kode_perusahaan" placeholder="Company Code" class="form-control" value="<?= $q['kode_perusahaan']?>" required>
            <div class="input-group-addon "><i class="fa fa-code"></i></div>
        </div>
        <br>
        <label>Company Name <a class="required">*</a></label>
        <div class="input-group">
            <input type="text" name="nama_perusahaan" placeholder="Company Name" class="form-control" value="<?= $q['nama_perusahaan']?>" required>
